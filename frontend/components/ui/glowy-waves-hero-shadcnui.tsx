...
const highlightPills = [
  ...
  "Candidate-ready feedback",
] as const;

const heroStats: { label: string; value: string }[] = [
  { label: "Interviews analyzed", value: "320+" },
  { label: "Feedback latency", value: "8ms" },
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/4 h-[400px] w-[400px] rounded-full bg-[#F48C06]/[0.02] blur-[150px] dark:bg-[#F48C06]/[0.05]" />
      </div>
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center px-6 py-24 text-center md:px-8 lg:px-12">
        ...
        >
          <motion.div
            ...
            className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-black/20 px-4 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-white/70 backdrop-blur"
          >
            <Sparkles className="h-4 w-4 text-[#F48C06]" aria-hidden="true" />
          ...
          >
            The deepest candidate intelligence{" "}
            <span className="bg-gradient-to-r from-[#F48C06] via-[#F48C06]/70 to-white/80 bg-clip-text text-transparent">
              anywhere
            </span>
          </motion.h1>
          ...
          >
            Analyze candidate responses, surface clear recruiter insights, and
            create a polished interview experience without leaving your product.
          </motion.p>
          ...
          <motion.div
            ...
            className="grid gap-4 rounded-2xl border border-white/10 bg-black/20 p-6 backdrop-blur-sm sm:grid-cols-3"
          >
            {heroStats.map((stat) => (
              <motion.div
                key={stat.label}
